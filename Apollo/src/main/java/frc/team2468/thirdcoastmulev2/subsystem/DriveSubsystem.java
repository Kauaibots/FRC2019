...
public class DriveSubsystem extends PIDSubsystem {
  ...
  public boolean rotationHeld(){
    if(Robot.oi.getDriveStick().getRawButton(9)|Robot.oi.getDriveStick().getRawButton(10)|Robot.oi.getDriveStick().getRawButton(11)|Robot.oi.getDriveStick().getRawButton(12)){
      return true;
    }
    else return false;
