...
public abstract class Wheel {
  ...
  public void set(double azimuth, double drive) {
    ...
    SmartDashboard.putNumber("Az" + azimuthTalon.getDeviceID().ToString(), azimuthPosition + azimuthError);
    System.out.println(("Az" + azimuthTalon.getDeviceID().ToString() + " - " + Double(azimuthPosition + azimuthError).ToString()); 
