...
public class Controls {
  ...
  private static final int DRIVER_X_AXIS = 0;
  private static final int DRIVER_Y_AXIS = 1;
  private static final int DRIVER_LEFT_Y_AXIS = 2;
  private static final int DRIVER_TUNER_AXIS = 3;
  private static final int DRIVER_Z_AXIS = 4;
  ...
  public double getForward() {
    return -driverController.getRawAxis(DRIVER_Y_AXIS);
  }
  ...
  public double getStrafe() {
    return driverController.getRawAxis(DRIVER_X_AXIS);
  }
  ...
  public double getAzimuth() {
    return driverController.getRawAxis(DRIVER_Z_AXIS);
  }
